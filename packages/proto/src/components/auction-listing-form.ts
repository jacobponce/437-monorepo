...
export class AuctionListingFormElement extends LitElement {
  @state()
    ...
    return html`
      <form @submit=${this.handleSubmit}>
        <div class="form-group">
          <label for="title">
            ...
            <input
              ...
              name="title"
              required
              placeholder="e.g., Taylormade TP5x Golf Balls (12pc)"
        ...
        <div class="form-actions">
          ...
          <a href="auctions.html" class="btn btn-secondary">Cancel</a>
        </div>
      </form>
    `;
  }
